...
gchar const* j_configuration_get_smd_server (JConfiguration*, guint32);

guint32 j_configuration_get_object_server_count (JConfiguration*);
guint32 j_configuration_get_kv_server_count (JConfiguration*);
guint32 j_configuration_get_smd_server_count (JConfiguration*);
...
gchar const* j_configuration_get_smd_backend (JConfiguration*);
gchar const* j_configuration_get_smd_component (JConfiguration*);
gchar const* j_configuration_get_smd_path (JConfiguration*);
